...
class OpenDialogFragment : DialogFragment() {
    ...
    private lateinit var rbMout: RadioButton
    private lateinit var rbVlg: RadioButton
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rbVlg = view.findViewById(R.id.rb_lvg)
        rbMout = view.findViewById(R.id.rb_mou)
        ...
        btnChoose.setOnClickListener {
            ...
            if (checkedRadioButtonId != -1) {
                var coach: String? = when (checkedRadioButtonId) {
                    ...
                    R.id.rb_mou -> rbMout.text.toString().trim()
                    R.id.rb_lvg -> rbVlg.text.toString().trim()
    ...
    override fun onAttach(context: Context) {
        ...
        if (fragment is FragmentDetailcategory) {
